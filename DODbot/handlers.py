...
async def quest_handler(message):
    ...
    await message.answer(
        """🎉 Вам предстоит увлекательное путешествие по стендам всех Физтех-школ! Выполняйте задания и получайте баллы.\n
📈 За каждое выполненное задание от Физтех-школы вы сможете получить от 1 до 2 баллов.\n
🎁 Самые активные и сообразительные участники получат крутые призы: пауэрбанки, футболки, блокноты и многое другое! 🎨 Обменять накопленные баллы на мерч можно в холле 1 этажа Главного корпуса. А ещё у вас есть возможность создать свой уникальный мерч на интерактиве «Разрисуй свой мерч» в 2.35 Физтех.Цифры!\n
🧩 Правила обмена баллов на мерч:
– шоппер для рисования — 5 баллов
– шоппер с символикой МФТИ — 6 баллов
– футболка для рисования — 7 баллов
– футболка с символикой МФТИ — 8 баллов
– пауэрбанк — 15 баллов.
    """,
